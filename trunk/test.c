...
int main(int argc, char **argv)
{
  ...
  curl_easy_setopt(http_handle, CURLOPT_URL, "http://www.360quan.com");


  http_handle1 = curl_easy_init();
  /* set the options (I left out a few, you'll get the point anyway) */
  curl_easy_setopt(http_handle1, CURLOPT_URL, "http://www.google.com/");

  http_handle2 = curl_easy_init();
  /* set the options (I left out a few, you'll get the point anyway) */
  curl_easy_setopt(http_handle2, CURLOPT_URL, "http://www.taobao.com/");
